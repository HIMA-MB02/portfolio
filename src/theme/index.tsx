const theme = {
    ...
    color: {
        ...
        redGradient: 'linear-gradient(60deg, #8a2387, #e94057, #f27121)',
        pinkGradient: 'linear-gradient(60deg, #de6262, #ffb88c)',
        greenGradient: 'linear-gradient(60deg, #fc354c, #0abfbc)',
        primary: '#5073b8',
        secondary: '#f79533',
        teritary: '#07b39b',
        red: '#f2023a'
